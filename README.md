...
→ select the **repository root**, the folder holding `extension.toml`. Zed
...
The language server itself is upstream's:
[shopware/shopware-lsp](https://github.com/shopware/shopware-lsp). Bugs in
